...
import LWSLogo from '../assets/image/logo.svg';
        ...
        <>
            <main>
                <section className="container">
                    ...
                    <div className="w-full md:w-1/2 mx-auto bg-[#030317] p-4 rounded-md mt-2">
                        ...
                        <div className="py-4 lg:py-6">
                            <p className="text-center text-lg text-gray-600/95 lg:text-sm">
            ...
            {/* Footer */}
            <footer className="my-2 md:my-4 bg-[#030317]">
                <div className="container mx-auto flex items-center justify-between">
                    ...
                    <ul className="flex items-center space-x-5">
                        <li className="text-center">
                            <div className="text-white/50 hover:text-white transition-all duration-200 cursor-pointer"
                            // href="#"
                            >
                                <svg
                                    height="24"
